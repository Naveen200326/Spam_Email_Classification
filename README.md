...
The model learns common spam patterns such as promotional keywords, suspicious phrases, and message structure.
...
NLP (Natural Language Processing) for text conversion & feature extraction
